...
export class PreferenceComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.preferenceService
      ...
      .subscribe(
        (res: HttpResponse<IPreference[]>) => this.paginatePreferences(res.body, res.headers),
  ...
  protected paginatePreferences(data: IPreference[], headers: HttpHeaders) {
