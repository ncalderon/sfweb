...
export class TranCategoryComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.tranCategoryService
      ...
      .subscribe(
        (res: HttpResponse<ITranCategory[]>) => this.paginateTranCategories(res.body, res.headers),
  ...
  trackId(index: number, item: ITranCategory) {
    return item.id;
  }
  ...
  protected paginateTranCategories(data: ITranCategory[], headers: HttpHeaders) {
