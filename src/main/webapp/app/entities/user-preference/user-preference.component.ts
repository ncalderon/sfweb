...
export class UserPreferenceComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.userPreferenceService
      ...
      .subscribe(
        (res: HttpResponse<IUserPreference[]>) => this.paginateUserPreferences(res.body, res.headers),
  ...
  transition() {
    this.router.navigate(['/user-preference'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: IUserPreference) {
    return item.id;
  }
  ...
  protected paginateUserPreferences(data: IUserPreference[], headers: HttpHeaders) {
