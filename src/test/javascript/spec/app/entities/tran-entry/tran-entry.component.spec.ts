...
import { TranEntryComponent } from 'app/entities/tran-entry/tran-entry.component';
...
describe('Component Tests', () => {
  describe('TranEntry Management Component', () => {
    let comp: TranEntryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TranEntryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tranEntries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
