package com.sf.config.timezone

import com.sf.SfwebApp
import com.sf.repository.timezone.DateTimeWrapper
import com.sf.repository.timezone.DateTimeWrapperRepository
...
class HibernateTimeZoneIT {
    ...
    private fun generateSqlRequest(fieldName: String, id: Long): String {
        return format("SELECT %s FROM sf_date_time_wrapper where id=%d", fieldName, id)
    }
